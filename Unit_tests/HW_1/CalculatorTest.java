...
//        проверяем утверждения, связанные с правильностью вычисления цены со скидкой
        assertThat(Calculator.calculatingDiscount(10000.0, 70)).isEqualTo(3000.0);
        assertThat(Calculator.calculatingDiscount(1500.0, 7)).isEqualTo(1395.0);
        assertThat(Calculator.calculatingDiscount(500, 10)).isEqualTo(450.0);
        assertThat(Calculator.calculatingDiscount(20, 0)).isEqualTo(20);
